...
namespace Eaven.Ven.Host
{
    ...
    public abstract class ServicesRegistration
    {
        ...
        public ServicesRegistration(IConfiguration configuration, IServiceCollection services)
        {
        ...
        //public virtual void AddAuthorization<THandler>() where THandler : PermissionHandler
        //{
        //    //自定义授权配置
        ...
        //protected virtual void AddRpcService<TRpcService>(string serviceName, List<IAsyncPolicy<HttpResponseMessage>> policies  ) where TRpcService : class, IRpcService
        //{
